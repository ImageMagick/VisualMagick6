...
BOOL CConfigureApp::InitInstance()
{
  ...
  wizard.m_Page2.m_excludeDeprecated=excludeDeprecated;
  ...
  if (TRUE)
#endif // __NO_MFC__
    {
      ...
      excludeDeprecated = wizard.m_Page2.m_excludeDeprecated;
...
bool ConfigureProject::can_write_file(string &filename)
{
  ...
  return (filename != "..\\..\\magick\\widget.c" &&
          filename != "..\\..\\wand\\animate.c" &&
          filename != "..\\..\\wand\\display.c" &&
          filename != "..\\..\\wand\\import.c");
}
